...
| Project 3 | Hybrid relational model with multiple data grains, NTILE risk scoring, DAX What-If parameter, Decomposition Tree |
...
| Hybrid relational model with multiple data grains | Project 3 |
